...
<table class="table table-bordered table-striped">
    ...
    <tr>
      <td class="col1">Температура паров в перегонном кубе</td>
      <td class="col3l">
     		<div class="form-group" id="heatingTemp1MinDiv">
      		...
      		<div class="form-group" id="heatingTemp1MaxDiv">
      			<label for="heatingTemp1Max" class="col-sm-2 control-label">До: </label>
      			<div class="col-sm-9">
      ...
      <td class="col3l">
     		<div class="form-group" id="onFirstTemp1MinDiv">
      		...
      		<div class="form-group" id="onFirstTemp1MaxDiv">
      ...
      <td class="col3l">
     		<div class="form-group" id="onSecondTemp1MinDiv">
      		...
      		<div class="form-group" id="onSecondTemp1MaxDiv">
      ...
      <td class="col3l">
     		<div class="form-group" id="onThirdTemp1MinDiv">
      		...
      		<div class="form-group" id="onThirdTemp1MaxDiv">
      ...
      <td class="col3l">
     		<div class="form-group" id="crashTemp1MinDiv">
      		...
      		<div class="form-group" id="crashTemp1MaxDiv">
    ...
    <tr>
      <td class="col1">Температура паров в блоке МСД</td>
      <td class="col3l">
     		<div class="form-group" id="heatingTemp2MinDiv">
      		...
      		<div class="form-group" id="heatingTemp2MaxDiv">
      ...
      <td class="col3l">
     		<div class="form-group" id="onFirstTemp2MinDiv">
      		...
      		<div class="form-group" id="onFirstTemp2MaxDiv">
      ...
      <td class="col3l">
     		<div class="form-group" id="onSecondTemp2MinDiv">
      		...
      		<div class="form-group" id="onSecondTemp2MaxDiv">
      ...
      <td class="col3l">
     		<div class="form-group" id="onThirdTemp2MinDiv">
      		...
      		<div class="form-group" id="onThirdTemp2MaxDiv">
      ...
      <td class="col3l">
     		<div class="form-group" id="crashTemp2MinDiv">
      		...
      		<div class="form-group" id="crashTemp2MaxDiv">
    ...
    <tr>
      <td class="col1">Состояние основного нагревательного элемента</td>
      <td class="col3l">
      	<div class="radio" id="heatingMainPowerOnDiv">
  			<label>
    			<input type="radio" name="heatingMainPower" id="heatingMainPowerOn" value="on">
    			<strong>Вкл.</strong>
  			</label>
		</div>
		<div class="radio" id="heatingMainPowerOffDiv">
  			<label>
      ...
      <td class="col3l">
      	<div class="radio" id="onFirstMainPowerOnDiv">
  			<label>
    			<input type="radio" name="onFirstMainPower" id="onFirstMainPowerOn" value="on">
    			<strong>Вкл.</strong>
  			</label>
		</div>
		<div class="radio" id="onFirstMainPowerOffDiv">
  			<label>
      ...
      <td class="col3l">
      	<div class="radio" id="onSecondMainPowerOnDiv">
  			<label>
    			<input type="radio" name="onSecondMainPower" id="onSecondMainPowerOn" value="on">
    			<strong>Вкл.</strong>
  			</label>
		</div>
		<div class="radio" id="onSecondMainPowerOffDiv">
  			<label>
      ...
      <td class="col3l">
      	<div class="radio" id="onThirdMainPowerOnDiv">
  			<label>
    			<input type="radio" name="onThirdMainPower" id="onThirdMainPowerOn" value="on">
    			<strong>Вкл.</strong>
  			</label>
		</div>
		<div class="radio" id="onThirdMainPowerOffDiv">
  			<label>
    ...
    <tr>
      <td class="col1">Состояние дополнительного нагревательного элемента</td>
      <td class="col3l">
      	<div class="radio" id="heatingAddPowerOnDiv">
  			<label>
    			<input type="radio" name="heatingAddPower" id="heatingAddPowerOn" value="on">
    			<strong>Вкл.</strong>
  			</label>
		</div>
		<div class="radio" id="heatingAddPowerOffDiv">
  			<label>
      ...
      <td class="col3l">
      	<div class="radio" id="onFirstAddPowerOnDiv">
  			<label>
    			<input type="radio" name="onFirstAddPower" id="onFirstAddPowerOn" value="on">
    			<strong>Вкл.</strong>
  			</label>
		</div>
		<div class="radio" id="onFirstAddPowerOffDiv">
  			<label>
      ...
      <td class="col3l">
      	<div class="radio" id="onSecondAddPowerOnDiv">
  			<label>
    			<input type="radio" name="onSecondAddPower" id="onSecondAddPowerOn" value="on">
    			<strong>Вкл.</strong>
  			</label>
		</div>
		<div class="radio" id="onSecondAddPowerOffDiv">
  			<label>
      ...
      <td class="col3l">
      	<div class="radio" id="onThirdAddPowerOnDiv">
  			<label>
    			<input type="radio" name="onThirdAddPower" id="onThirdAddPowerOn" value="on">
    			<strong>Вкл.</strong>
  			</label>
		</div>
		<div class="radio" id="onThirdAddPowerOffDiv">
  			<label>
...
<script src="tf.js" defer></script>
<script src="click.js" defer></script>
<script src="inputCheck.js" defer></script>
